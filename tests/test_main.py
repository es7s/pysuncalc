...
class Test:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (ts2dtz(1694202441), 55.7558, 37.6172, {SUNRISE: ts2dt(1694141286)}, []),
            (ts2dtz(1694202441), 55.7558, 37.6172, {SUNSET: ts2dt(1694189383)}, []),
            (ts2dtz(1554757485), 56.07, 47.14, {ZENITH: ts2dt(1554800055)}, []),
