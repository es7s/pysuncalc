...
ts2dtu = partial(datetime.fromtimestamp, tz=timezone(timedelta(hours=0)))
ts2dtl = partial(datetime.fromtimestamp, tz=timezone(timedelta(hours=3)))
...
class Test:
    @pytest.mark.parametrize(
        ...
        [
            (ts2dtl(1694198261), 55.7558, 37.6172, (2.34878, -0.33646)),
